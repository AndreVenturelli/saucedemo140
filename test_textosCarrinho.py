...
class TestTextosCarrinho():
  def setup_method(self, method):
    self.driver = webdriver.Chrome()
    self.vars = {}
    self.driver.implicitly_wait(5)#esse é o melhor jeito de "parar a aplicação".
  
  def teardown_method(self, method):
    self.driver.quit()
  
  def test_textosCarrinho(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, "*[data-test=\"inventory-container\"]").click()
    ...
    #time.sleep(2) esse aqui é um jeito temporario, como se fosse um gambiarrinha
